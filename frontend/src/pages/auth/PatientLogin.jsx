                    ...
                    <div className="relative z-10 text-center space-y-8">
                        ...
                        <div className="space-y-4 pt-8">
                            <div className="flex items-center gap-3 text-left">
                                ...
                                <span className="text-emerald-50">Access Your EMR Anytime</span>
                            </div>
                            <div className="flex items-center gap-3 text-left">
                                <div className="w-10 h-10 bg-white/20 rounded-xl flex items-center justify-center backdrop-blur-sm">
                                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <span className="text-emerald-50">Secure OTP Login</span>
                            </div>
                            <div className="flex items-center gap-3 text-left">
                                <div className="w-10 h-10 bg-white/20 rounded-xl flex items-center justify-center backdrop-blur-sm">
                                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <span className="text-emerald-50">Real-time Lab Reports</span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        {step === 'email' ? (
                            <form onSubmit={handleSendOtp} className="space-y-6">
                                ...
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className="w-full py-4 px-6 bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-semibold rounded-xl shadow-lg shadow-emerald-500/30 hover:shadow-xl hover:shadow-emerald-500/40 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                            ...
                            <form onSubmit={handleVerifyOtp} className="space-y-6">
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 tracking-[1em] text-center text-2xl font-bold focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 outline-none transition-all duration-200"
                                        placeholder="------"
                                    />
                                </div>

                                {message && (
                                    <div className="p-4 bg-emerald-50 border-l-4 border-emerald-500 rounded-lg animate-slideIn">
