                    ...
                    <div className="relative z-10 text-center space-y-8">
                        ...
                        <div className="space-y-4 pt-8">
                            <div className="flex items-center gap-3 text-left">
                                ...
                                <span className="text-blue-50">Streamlined Patient Care</span>
                            </div>
                            <div className="flex items-center gap-3 text-left">
                                <div className="w-10 h-10 bg-white/20 rounded-xl flex items-center justify-center backdrop-blur-sm">
                                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div className="flex items-center gap-3 text-left">
                                ...
                                <span className="text-blue-50">Real-time Updates</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="space-y-8">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        onChange={handleChange}
                                        className="w-full px-4 py-3 pr-12 rounded-xl border-2 border-gray-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-none transition-all duration-200 input-medical"
                                        placeholder="Enter your password"
                                    />
                                    <button
                                        type="button"
                                        onClick={() => setShowPassword(!showPassword)}
                                        className="absolute inset-y-0 right-0 flex items-center px-4 text-gray-500 hover:text-blue-600 transition-colors duration-200"
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full py-4 px-6 btn-medical-primary font-semibold rounded-xl shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                            >
                                {loading ? (
                        ...
                        <div className="pt-6 border-t border-gray-100">
                            <div className="text-center space-y-3">
                                ...
                                <Link
                                    to="/patients-login"
                                    className="inline-flex items-center gap-2 px-6 py-3 bg-blue-50 text-blue-700 font-bold rounded-xl hover:bg-blue-100 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 group"
                                >
                    ...
                    <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden transform transition-all scale-100">
                        <div className="p-6 text-center space-y-4">
                            ...
                            <p className="text-gray-600">
                                Please contact the <span className="font-semibold text-blue-600">Administrator</span> to reset your password.
                            </p>
