...
export default function DoctorDashboard() {
    ...
    const getStatusBadge = (status) => {
        ...
        return badges[status.toLowerCase()] || "bg-gray-100 text-gray-700 border border-gray-200";
    };
                    ...
                    <div className="max-w-7xl mx-auto space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            <div className="card-medical p-6 border-l-4 border-blue-500">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="text-xs font-medium text-gray-500 uppercase mb-2">Today's Appointments</p>
                            ...
                            <div className="card-medical p-6 border-l-4 border-amber-500">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="text-xs font-medium text-gray-500 uppercase mb-2">Pending Consultations</p>
                                        <p className="text-3xl font-bold text-gray-900">{stats.pendingConsultations}</p>
                                    </div>
                            ...
                            <div className="card-medical p-6 border-l-4 border-green-500">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="text-xs font-medium text-gray-500 uppercase mb-2">Completed Today</p>
                            ...
                            <div className="card-medical border-l-4 border-red-500 p-6">
                                ...
                                <div className="space-y-3">
                                    {emergencyPatients.map(patient => (
                                        <div key={patient.id} className="p-4 bg-red-50 rounded-lg flex items-center justify-between border border-red-200 cursor-pointer hover:bg-red-100 transition-colors" onClick={() => setSelectedPatient(patient)}>
                                            <div className="flex items-center gap-4">
                                            ...
                                            <div className="flex items-center gap-4">
                                                <div onClick={(e) => e.stopPropagation()}>
                                                    <select
                                                        ...
                                                        className="px-2 py-1 text-sm rounded border border-red-300 text-red-800 focus:outline-none focus:border-red-500 bg-white"
                                                    >
                                            ...
                                            <tr key={patient.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                                                ...
                                                <td className="py-4 px-4">
                                                    <select
                                                        ...
                                                        className={`px-3 py-1.5 rounded-lg text-xs font-semibold border focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer transition-all ${getStatusBadge(patient.status)}`}
                                                    >
                                                ...
                                                <td className="py-4 px-4">
                                                    <button onClick={() => setSelectedPatient(patient)} className="btn-medical-secondary px-3 py-1.5 text-sm rounded-lg font-medium">
                                                        View
                                                    </button>
                                                </td>
                                            </tr>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            {/* Current IPD */}
                            <div className="card-medical border-l-4 border-indigo-500 p-6">
                                <h2 className="text-xl font-bold text-gray-900 mb-5">Current IPD Patients</h2>
                                <div className="space-y-3">
                                    {ipdCurrent.map(patient => (
                                        <div key={patient.id} className="p-4 border border-gray-200 rounded-lg hover:border-indigo-300 hover:shadow-sm transition-all cursor-pointer" onClick={() => setSelectedPatient(patient)}>
